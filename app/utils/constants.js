...
var C = {
    DEFAULT_SLACK_CARD_NAME:'Default',
    GRAFANA_LINK:{
        DASHBOARD_NAME:'openebs-volume-stats?',
        ORG_ID_GRAFANA:'orgId=1&var-OpenEBS='
    },
    AUTH_TYPES: {
        AdminAuth: 'None',
        BasicAuth: 'API Key',
    ...
    GITHUB: {
        ...
        PROXY_URL: '/github/',
        SCOPE: 'read:org',
        PROFILE_PIC : 'https://avatars3.githubusercontent.com/u/'
    },
    ...
    USER: {
        ...
        ACCESS_PERMISSION_ALLOWED :true,
        ACCESS_PERMISSION_DENIED : false,
    },
};
