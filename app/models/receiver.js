...
var Receiver = Resource.extend(PolledResource, {
    ...
    actions: {
        edit() {
            this.get('router').transitionTo('mayasecure.project.hooks.edit-receiver', this.get('id'));
        },

        clone: function() {
            this.get('router').transitionTo('mayasecure.project.hooks.new-receiver', {queryParams: {receiverId: this.get('id')}});
        },
    },
