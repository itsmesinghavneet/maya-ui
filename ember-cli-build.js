...
module.exports = function(defaults) {
  ...
  app.import('bower_components/remarkable-bootstrap-notify/bootstrap-notify.js');
  app.import('bower_components/animate.css/animate.css');
  //icons
  app.import('vendor/icons/line-awesome-font-awesome.min.css');
  app.import('vendor/icons/fonts/line-awesome.eot',   { destDir: 'assets/fonts/'});
  app.import('vendor/icons/fonts/line-awesome.svg',   { destDir: 'assets/fonts/'});
  app.import('vendor/icons/fonts/line-awesome.ttf',   { destDir: 'assets/fonts/'});
  app.import('vendor/icons/fonts/line-awesome.woff',   { destDir: 'assets/fonts/'});
  app.import('vendor/icons/fonts/line-awesome.woff2',   { destDir: 'assets/fonts/'});

  //Fonts
  //Open-Sans
  app.import('vendor/opensans/open-sans-v15-latin-300.woff', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-300.woff2', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-600.woff', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-600.woff2', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-700.woff', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-700.woff2', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-regular.woff', { destDir: 'assets/fonts/'});
  app.import('vendor/opensans/open-sans-v15-latin-regular.woff2', { destDir: 'assets/fonts/'});
